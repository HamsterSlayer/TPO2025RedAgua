...
public class ArbolAVL {
    ...
    private void listarRangoAux(NodoAVL n, Comparable minNomb, Comparable maxNomb, int minVol, int maxVol, int m, int a,
            Lista l) {
        ...
        if (minNomb.compareTo(n.getElem().getNombre()) < 0 && maxNomb.compareTo(n.getElem().getNombre()) > 0) {
            ...
            if (consumo > minVol && consumo < maxVol) {
                l.insertar(n.getElem().getNombre(), 1);// Esta en inOrder invertido para que la lista liste en orden sin
                                                       // necesidad de usar longitud().
            }
        }
